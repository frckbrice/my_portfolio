...
export const projects: WorkType[] = [
    ...
    },
    {
        ...
        description: "A web application that allows users to discover museums around the world. It is built with Next.js, TypeScript, shadcn/ui, and tailwind css, and @tanstack/react-query. this is a Frontend application that allows users to discover museums around the world.",
        stack: [
            { name: "Next.js" },
            { name: "TypeScript" },
            { name: "Shadcn/ui" },
    ...
    },
    {
        ...
        topics: ["fullstack", "school", "management", "web-app", "ORange Money", "MTN Momor"],
        images: ["/assets/work/school_1.png", "/assets/work/school_2.png", "/assets/work/school_3.png",],
