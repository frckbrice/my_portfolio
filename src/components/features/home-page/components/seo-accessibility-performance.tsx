...
const seoFeatures = [
    {
        ...
        description: "Comprehensive SEO implementation with Next.js metadata API, structured data, and performance optimization for better search rankings.",
        features: [
    ...
    },
    {
        ...
        description: "WCAG AA compliant design with semantic HTML, ARIA labels, keyboard navigation, and screen reader support for inclusive user experience.",
        features: [
    ...
    },
    {
        ...
        description: "Lightning-fast performance with SSR, Core Web Vitals optimization, and modern web technologies for exceptional user experience.",
        features: [
            ...
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                        This portfolio demonstrates advanced expertise in SEO, accessibility, and performance optimization -
                        the three pillars of modern web development that ensure your digital presence reaches its full potential.
                    </p>
                </motion.div>
                ...
                >
                    <div className="bg-card/30 backdrop-blur-sm rounded-xl p-8 border border-border">
                        ...
                        <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                            Let me help you create websites and applications that not only look great but also perform exceptionally,
                            rank well in search engines, and are accessible to everyone.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-8 py-3 bg-card/50 text-foreground font-semibold rounded-lg border border-border hover:bg-card hover:border-accent/50 transition-all duration-300"
                            >
                                Get In Touch
                            </motion.button>
                        </div>
