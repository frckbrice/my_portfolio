            ...
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                        Let's collaborate to bring your ideas to life. Whether you need a new website,
                        mobile app, or complex software solution, I'm here to help you succeed.
                    </p>
                    ...
                    <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <div className="text-muted-foreground">Available for Consultation</div>
                        </motion.div>
