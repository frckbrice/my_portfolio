...
const techHighlights = [
    ...
    },
    {
        ...
        title: "Mobile & Web",
        description: "Cross-platform development for iOS, Android, and web applications",
        color: "text-pink-400"
    },
    {
        icon: <Database className="w-8 h-8" />,
        title: "Database Architect",
        description: "Designing efficient database schemas and data management systems",
            ...
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                        Combining deep technical expertise with creative problem-solving to deliver exceptional digital solutions
                    </p>
                </motion.div>
                    ...
                    {techHighlights.map((highlight, index) => (
                        ...
                        >
                            <div className="bg-card/50 backdrop-blur-sm rounded-xl p-6 border border-border hover:border-accent/50 transition-all duration-300 h-full theme-transition">
                                <div className={`${highlight.color} mb-4 group-hover:scale-110 transition-transform duration-300`}>
                                    {highlight.icon}
                                </div>
